...
contract CustomCrowdSale {
    ...
    */
    function CustomCrowdSale( 
        ...
        tokenReward = token(0x436E321B9313552541D7ea07C57D525De0c4d65F); // place token contract address of the desired token to be issued. 
        beneficiary = 0x7c0A0ab098daB73C7F0Bd704613Cbf2e29f33328; //place desired address eligible to withdraw eth from this contract.
        startTimestamp;
