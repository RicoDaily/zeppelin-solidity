...
contract CustomTokenName is PausableToken {
    using SafeMath for uint256;

    string public name = "Custom Token Name";
    string public symbol = "CTN";
    uint256 public decimals = 18;
    uint256 public totalSupply = 20000000 * (10 ** decimals);
    address public beneficiary = 0xf9fE46227013EFBcc0255b4CEd93192Fe2F6a097;

    mapping (address => uint256) public spawnWallet;

    function CustomTokenName() public {
